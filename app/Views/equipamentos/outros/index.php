...
<div class="card p-4">
    ...
    <div class="row py-3 my-3">
        ...
        <div class="col-md-4 btn-group">
            ...
            <button class="btn btn-success" onclick="openModalOutros()" >Filtros</button>
    ...
    <p>
        Outros objetos localizados: <span id="outrosCount">0</span>
    </p>

    <div id="tableOutros" class="collapsed p-4 justify-content card">
...
<script>
    const tableOutros = document.getElementById('tableOutros');
    const outrosCount = document.getElementById('outrosCount')
    ...
    const search = () => {
        ...
        outrosCount.innerText = 'Carregando...'
    ...
    const renderTableTwo = (data) => {
        outrosCount.innerText = data.length

        const tbody = document.querySelector('tbody')
        tbody.innerHTML = ''
        data.forEach(outro => {

            Object.keys(outro).forEach(key => {
                if (outro[key] === null) {
                    outro[key] = ''
                }
            });
                ...
                <td class='text-end'>
                    <div class="dropstart">
                        ...
                        <ul class="dropdown-menu text-center me-2" style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(7px); border-radius: 15px; border: 2px solid #198754;">
                            <li class="dropdown-item" onclick="editOutro(${outro.id})">Editar</li>
                            <li class="dropdown-item" onclick="deleteOutro(${outro.id})">Excluir</li>
                        </ul>
                    </div>
                </td>
            `
        ...
        tableOutros.classList.add('show');
    }
