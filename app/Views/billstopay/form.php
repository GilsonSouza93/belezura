    ...
    <form>
        ...
        <div class="row">
            ...
            <div class="mt-3 col-md-2">
                ...
                <select class="form-control" id="pop_id" aria-label="pop" name="pop" >
            ...
            <div class="mt-3 col-md-2">
                ...
                <select class="form-control" id="suplier_id" aria-label="fornecedor" name="suplier_id">
            ...
            <div class="mt-3 col-md-2">
                ...
                <select class="form-control" id="paymentform_id" aria-label="formadepagamento" name="paymentform_id" >
            ...
            <div class="mt-5 col-md-2 py-2 px-5 form-check">
                <label class="form-check-label" for="fixvalue_id"></label>
                <input type="checkbox" class="form-check-input" name="fixvalue_id" id="fixvalue_id" checked> Valor Fixo:
            </div>
            <div class="mt-3 col-md-2">
                <label for="valor" class="form-label">Valor</label>
                <input type="text" class="form-control" id="value_id" name="value_id" placeholder="">
            </div>
        </div>
        ...
        <div class="row">
            <div class="mt-3 col-md-12">
                ...
                <input type="text" id="obs_id" class="form-control" name="obs_id" placeholder="">
            </div>
        </div>
        ...
        <div class="row">
            <div class="mt-3 col-md-3">
                ...
                tipoDoDocumento_id" id="tipododocumento_id" aria-label="tipo do documento">
            ...
            <div class="mt-3 col-md-3">
                ...
                <input type="text" id="notaFiscal_id" class="form-control" name="notaFiscal_id" placeholder="">
            </div>
            <div class="mt-3 col-md-3">
                <label for="dataDeEmissao" class="form-label">Data de Emissão</label>
                <input type="date" id="dataDeEmissao_id" class="form-control" name="dataDeEmissao_id" placeholder="">
            </div>
        </div>
        <div class="row">
        <div class="mt-3 col-md-6">
                <label for="vencimento" class="form-label">Vencimento</label>
                <input type="date" id="timeout_id" class="form-control" name="timeout_id" placeholder="">
            </div>
            <div class="mt-3 col-md-6 form-check">
                <label for="tipoDeParcela" class="form-label">Tipo de Parcela</label>
                    <select class="form-control select2" id="tipoDeParcela_id" aria-label="Default select example">
