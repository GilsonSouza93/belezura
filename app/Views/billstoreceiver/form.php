    ...
    <form>
        ...
        <div class="row">
            <div class="mt-3 col-md-2">
                ...
                <select class="form-control" id="empresa" aria-label="empresa">
            ...
            <div class="mt-3 col-md-2">
                ...
                <select class="form-control" id="fornecedor" aria-label="fornececdor">
            ...
            <div class="mt-3 col-md-2">
                ...
                <select class="form-control" id="formaDePagamento" aria-label="Default select example">
        ...
        <div class="row">
            <div class="mt-3 col-md-3">
                ...
                <select class="form-control" id="tipoDoDocumento" aria-label="Default select example">
        ...
        <div class="mt-3 col-md-6">
            ...
            <div class="mt-3 col-md-6 form-check">
                <label for="tipoDeParcela" class="form-label">Tipo de Parcela</label>
                    <select class="form-control" id="tipoDeParcela" aria-label="Tipo de parcela">
